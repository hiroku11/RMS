...
export class UserCourseDetailComponent implements OnInit {
  ...
  saveCouseProgress() {
    this._apiService.put('/user-course-entity/update-my-progress', {
      id: this.course.userCourseId,
      actualStartDateTime: this.course.userCourseActualStartDateTime,
      actualEndDateTime: this.course.userCourseActualEndDateTime
    }).subscribe((data) => {
      this._alertService.success('Course progress updated successfully.');
    }, (error) => {
