...
@Component({
  selector: 'app-office-address-lookup',
  templateUrl: './office-address-lookup.component.html',
  styleUrls: ['./office-address-lookup.component.scss']
})
export class OfficeAddressLookupComponent implements OnInit {
  display: boolean;
  itemsCount: any;
  searchUrl: string = '/office-address/search-office-address';
  lookupOptions: any = {};
  searchResult: any;
  ...
  searchOrgs() {
    this._apiService
      ...
      .subscribe((data) => {
        ...
        this.searchResult = data.officeAddresses;
      }, (error) => {
